...
class UserFavorite(models.Model):
    ...
    TYPE_CHOICES = ((1, u"课程"), (2, u"课程机构"), (3, u"讲师"), (4, u"文章"), (5, u"职位"))
    # 机智版 # 直接保存用户的id.
...
ContentType_Map = {
    1: ContentType.objects.get(app_label__exact="courses", model__exact="course"),
    # 2: ContentType.objects.get(app_label__exact="article", model__exact="article"),
    3: ContentType.objects.get(app_label__exact="organization", model__exact="teacher"),
    4: ContentType.objects.get(app_label__exact="article", model__exact="article"),
    5: ContentType.objects.get(app_label__exact="jobs", model__exact="jobs"),
}
