PERSONALITY = [
    ("绿色", "正面：温和 耐心 包容   负面：软弱 缺乏主见 惰性", '''
            性格优势：
       作为个体：　爱静不爱动，有温柔祥和的吸引力和宁静愉悦的气质；和善的天性，做人厚道；追求人际关系的和谐；奉行中庸之道，为人稳定低调；遇事以不变应万变，镇定自若；知足常乐，心态轻松；追求平淡的幸福生活；有松弛感，能融入所有的环境和场合；从不发火，温和、谦和、平和三和一体；做人懂得“得饶人处且饶人”；追求简单随意的生活方式。
...
　　作为朋友：不负责任的和稀泥；姑息养奸的态度；压抑自己的感受以迁就别人，期待让人人满意，对自己的内心不忠诚；没有自我，迷失人生的方向；缺乏激情；漠不关心，惰于参与任何活动。
     ...
     "成熟的组织、中后台、稳定性高的岗位、能够应付复杂的人际关系"),

    ("黄色", "正面：强势 务实 领导力   负面：专制 同理心差 工作狂", '''性格优势：
    ...
    性格劣势：
    　　作为个体：自己永远是对的，死不认错；趾高气扬，霸道；只关注自己的感受，不体贴别人的心情和想法；以自我为中心，自私倾向；霸道；脾气暴躁，容易发怒；缺少同情心；傲慢自大，目中无人；经常紧绷自己的情绪；在情绪不佳或有压力的时候，经常会不可理喻与独断专行不喜欢受群体所规范约束,打破既定规则且自己不遵守规则。
    ...
    　　作为朋友：大多时候仅保持理性的友谊；讨厌与犹豫不决、能力弱的人互动；试图控制和影响大家的活动，希望他人服从自己而非配合别人；除了工作内容，很少交谈其它话题；情感上习惯与人保持一定的距离；很少对人流露出直接诚挚的关怀；需要你的时候才找你；为别人做主。
            ...
            ''',
     "开拓性强，适合从0到1的工作，天生的领导家，适宜创业或者加入创业团队、业务导向型团队"),

    ("蓝色", "正面：细致 规则 执行力强   负面：教条 敏感 纠结", '''
                性格优势：
    ...
    　　作为朋友：过度敏感，有时很难相处；强烈的不安全感；远离人群；喜好批判和挑剔；吝于宽恕；经常怀疑别人的话，不容易相信他人。
           对待工作和事业：对自己和他人常寄予过高而且不切实际的期望；过度计划和过度绸缪；患得患失，行动缓慢；较真，挑剔他人及自己的表现；专注于小细节，因小失大；吝啬表扬，强烈的形式主义；容易被不理想的成绩击垮斗志；墨守成规，死板教条不懂变通；为了维护原则缺乏妥协精神。''',
     "适合成熟的组织，规则意识强，适合从事法务等强调细节的岗位"),

    ("红色", "正面：交际 创意 自由   负面：随意 鲁莽 稳定性差", '''性格优势：
